...
class Pemesananlt1Page extends StatefulWidget {
   Pemesananlt1Page({required this.admin});

   bool admin;

  @override
  State<Pemesananlt1Page> createState() => _Pemesananlt1pageState(admin : admin);
}

class _Pemesananlt1pageState extends State<Pemesananlt1Page> {
  _Pemesananlt1pageState({required this.admin});
  bool admin;
                ...
                onTap: () {
                  showModalBottomSheet(
                    ...
                    builder: (BuildContext context){
                      return SizedBox(
                        height: 310,
                      child : Pemesanan(admin: admin,lantai: true,),
